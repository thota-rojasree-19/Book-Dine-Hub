...
//     const [availabilityError, setAvailabilityError] = useState(""); // New state for error message
...
//         setShowDateDialog(true); // Show calendar modal
//     };

//     // Updated to check availability before proceeding
...
//         try {
//             // Check if table is already booked for the selected date
...
//                 return; // Don't proceed if table is booked
//             }
...
//             setShowPaymentDialog(true); // Now show payment modal
//         } catch (error) {
...
//                                 Book Table
//                             </button>
//                             {/* <button className="cancel-button" onClick={isBooked ? cancelBooking : null} disabled={!isBooked}>
//                                 Cancel Booking
//                             </button> */}
//                         </div>
//                     </div>
...
//                                 setAvailabilityError(""); // Clear error when date changes
//                             }}
